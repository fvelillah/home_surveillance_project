...
- **Key Settings & Environment Knobs**:
  ...
  - **Dahua NVR Connection & URL Templates**:
    - `nvr_ip` (`DAHUA_NVR_IP`, default: `"192.168.1.100"`), `nvr_port` (`DAHUA_NVR_HTTP_PORT`, default: `80`), `nvr_user` (`DAHUA_NVR_USER`, default: `"admin"`), `nvr_password` (`DAHUA_NVR_PASSWORD`, default: `"your_password"`).
