                                ...
                                if hasattr(idx_assets_service, "retrieve"):
                                    ...
                                    while time.time() - t_idx_start < config.twelve_labs_upload_timeout:
                                        try:
                                            ...
                                            if st == "ready" or not isinstance(st, str):
...
def search_videos(
    ...
    if hasattr(search_results, "data") and search_results.data is not None:
        items_to_process = list(search_results.data)
    elif hasattr(search_results, "__iter__") and not isinstance(search_results, (dict, str)):
        try:
