...
Usage:
  ...
  python scripts/test_nvr_connection.py --ip 192.168.1.126 --user admin --password abc12345 --channels 9
...
def get_default_config() -> Dict[str, Any]:
    return {
        "ip": os.getenv("DAHUA_NVR_IP", "192.168.1.126"),
        "port": int(os.getenv("DAHUA_NVR_HTTP_PORT", "80")),
        "user": os.getenv("DAHUA_NVR_USER", "ai_surveillance"),
        "password": os.getenv("DAHUA_NVR_PASSWORD", "fer166326"),
